    ...
    <div class="wrap">
        ...
        <div class="mt-about-you-widget">
            <div class="widget footer">
                ...
                <img class="mt-about-avatar" src="{{ asset('visitor-assets') }}/images/about-me.jpg" alt="Clare Itsy" />
                ...
                <div class="mt-about-bio">
                    <p>Hi, my name is Clare and I&#039;m a serial blogger. I love life and more
                        than anything in the whole wide world, I love taking photographs. Oh and did I mention, I quite
                        like
                        blogging?</p>
                </div>
        ...
        <div class="widget footer">
            ...
            <div class="textwidget">
                <img src="{{ asset('visitor-assets') }}/images/gallery.png" alt="">
            </div>
        </div>
    </div>
...
<footer class="footer">
    <div class="footer-wrap">
        <div id="footer-text">&copy; 2021 Ahsan.
            Designed by <a href="#" target="_blank">Ahsan</a>.</div>
